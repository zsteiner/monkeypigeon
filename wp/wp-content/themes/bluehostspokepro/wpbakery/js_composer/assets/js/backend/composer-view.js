    ...
    var VisualComposer = Backbone.View.extend({
        ...
        render:function () {
            ...
            if (this.accessPolicy !== 'only') {
                ...
                /* randell Ripe */
                var def_page = $( '#page_template' ).val();
                if ( def_page == 'page-gallery.php' ) {
                    $('.composer-switch').slideUp('fast');
                    $('#wpb_visual_composer').slideUp('fast');
                    $('#postdivrich').slideUp('fast');
                    $('#spoke_gallery_settings').slideDown('fast');
                    $('#spoke_gallery_settings').addClass('shown');
                } else {
                    if ( $('#spoke_gallery_settings').hasClass('shown') ) {
                        $('#postdivrich').slideDown('fast');
                        $('#wpb_visual_composer').slideDown('fast');
                        $('.composer-switch').slideDown('fast');
                        $('#spoke_gallery_settings').slideUp('fast');
                        $('#spoke_gallery_settings').removeClass('shown');
                    }
                }
                /* randell */
            }

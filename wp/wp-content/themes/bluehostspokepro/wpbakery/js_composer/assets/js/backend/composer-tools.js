...
var us_row_section_dependency_callback = function() {
    var $section = this.$content.find('#section-yes'),
        $ = jQuery,
        $background = this.$content.find('[name=background]').parents('.vc-shortcode-param:first'),
        $full_width = this.$content.find('[name=full_width]').parents('.vc-shortcode-param:first'),
        $full_height = this.$content.find('[name=full_height]').parents('.vc-shortcode-param:first'),
        $img = this.$content.find('[name=img]').parents('.vc-shortcode-param:first'),
        $bg_fade = this.$content.find('[name=bg_fade]').parents('.vc-shortcode-param:first'),
        $parallax = this.$content.find('[name=parallax]').parents('.vc-shortcode-param:first'),
        $section_id = this.$content.find('[name=section_id]').parents('.vc-shortcode-param:first'),
        $include_to_menu = this.$content.find('#include_to_menu-yes'),
        $menu_title = this.$content.find('.row_title').parents('.vc-shortcode-param:first');
    ...
    $include_to_menu.change( function () {
        var checked = $(this).is(':checked');
        if (checked) {
            $menu_title.show();
        } else {
            $menu_title.hide();
            $menu_title.find('.row_title').val('');
        }
    });
    
    if ($include_to_menu.is(':checked')) {
        $menu_title.show();
    } else {
        $menu_title.hide();
        $menu_title.find('.row_title').val('');

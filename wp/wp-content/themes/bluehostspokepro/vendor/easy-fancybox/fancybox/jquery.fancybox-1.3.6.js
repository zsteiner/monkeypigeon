...
;(function($) {
	...
	$.fancybox.init = function() {
		...
		outer.append(
			...
			nav_left = $('<a href="javascript: $.fancybox.prev();" id="fancybox-left"><span class="fancy-ico" id="fancybox-left-ico"></span></a>'),
			nav_right = $('<a href="javascript: $.fancybox.next();" id="fancybox-right"><span class="fancy-ico" id="fancybox-right-ico"></span></a>')
		);

					...
					<div class="entry-container">
                     ...
                     <?php
                           $content = get_the_content();
							      ...
							      echo nl2br(substr(trim($content), 0, 128));
							?>
			...
			<div class="nav-links"> 
				<?php
                  ...
                  'next_text' => 'Next Posts',
						...
						/*'next_text' => '<i class="fa fa-caret-square-o-right"></i>',Previous Post
						'prev_text' => '<i class="fa fa-caret-square-o-left"></i>',Next Post*/
					) );
				?> 
			</div><!--nav-links--> 
		<?php else : ?>

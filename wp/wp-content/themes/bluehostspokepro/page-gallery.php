    ...
    <div class="w-portfolio-h">
        ...
        <div class="w-portfolio-list">
            ...
            <?php
                ...
                $gallery_id = get_post_meta($post->ID, 'spoke_page_gallery_id', true);
                $image_gallery = get_post_meta( $gallery_id, '_easy_image_gallery', true );
                $attachements = array_filter( explode( ',', $image_gallery ) );
